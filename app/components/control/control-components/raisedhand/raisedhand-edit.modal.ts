...
export class RaisedHandModalContext extends BSModalContext {
    id: number;
...
@Component({
    selector: 'app-raisedhand-edit-modal',
    styles: [
...
export class RaisedHandEditModal implements OnInit, ModalComponent<RaisedHandModalContext> {
    context: RaisedHandModalContext;

    constructor(public dialog: DialogRef<RaisedHandModalContext>) {
    }
