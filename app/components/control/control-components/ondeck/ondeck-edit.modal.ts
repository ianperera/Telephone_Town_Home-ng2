...
export class OnDeckModalContext extends BSModalContext {
    id: number;
...
@Component({
    selector: 'app-ondeck-edit-modal',
    styles: [
...
export class OnDeckEditModal implements OnInit, ModalComponent<OnDeckModalContext> {
    context: OnDeckModalContext;

    constructor(public dialog: DialogRef<OnDeckModalContext>) {
    }
